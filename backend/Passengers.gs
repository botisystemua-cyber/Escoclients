// ================================================================
// BotiLogistics_Passengers.gs — CRM Пасажири (менеджери)
...
var DB = {
  PASSENGERS: '1n6f5PL3Sj2MhhZHPeeQgo1BenjtUr2pkdU_Y7Kr0lAo',
  POSYLKI:    '1kcF3JchG5n7OzB_K2h9hxBqap7xHDnKN5nwMO9Fm2eo',
  MARHRUT:    '1Ku__ll0kDvp5dCeaS6QdnHrGGeoic-rykib6N1L7jeQ',
...
function doGet(e) {
  ...
  try {
    switch (action) {
      case 'ping':
        result = { ok: true, message: 'BotiLogistics CRM v3 API', version: '3.0', timestamp: new Date().toISOString() };
        break;
      case 'getAll':
